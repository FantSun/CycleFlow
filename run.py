...
if __name__ == '__main__':
    ...
    # Directories.
    parser.add_argument('--log_dir', type=str, default='run_cyc/logs')
    parser.add_argument('--model_save_dir', type=str, default='run_cyc/models')
    parser.add_argument('--sample_dir', type=str, default='run_cyc/samples')
